...
================================= -->
    <section class="breadcrumb-area section-padding img-bg-2 contactBanner">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <p class="info__text">
                            <a href="mailto:bridge1connect@gmail.com"> bridge1connect@gmail.com</a>
                        </p>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <p class="info__text">+229 57929477</p>
                        <p class="info__text">+229 55794294</p>
                    </div><!-- end info-box -->
                </div><!-- end col-lg-3 -->
            </div><!-- end row -->
