        ...
        <div class="hero-slider owl-action-styled">
                ...
                <div class="container">
                    <div class="hero-content">
                        <div class="section-heading">
                            <h2 class="section__title text-white fs-65 lh-80 pb-3">BRIDGE LANGUAGE AND CULTURE INSTITUTE
                                <br> Connecting Cultures
                            </h2>
                            <p class="section__desc text-white pb-4">Offers immersive language programs and
                                <br>cultural exchange initiatives to foster global understanding and fluency.
                            </p>
            ...
            <div class="hero-slider-item hero-bg-2">
                <div class="container">
                    <div class="hero-content text-center">
                        <div class="section-heading">
                            <h2 class="section__title text-white fs-65 lh-80 pb-3">Language <br> Program!</h2>
                            <p class="section__desc text-white pb-4">Our immersive curriculum fosters fluency and
                                confidence
                                <br> through practical application and interactive sessions for all proficiency levels.
                            </p>
                        </div><!-- end section-heading -->
            ...
            <div class="hero-slider-item hero-bg-3">
                <div class="container">
                    <div class="hero-content text-right">
                        <div class="section-heading">
                            <h2 class="section__title text-white fs-65 lh-80 pb-3">Cultural Exchange <br> Initiatives
                            </h2>
                            <p class="section__desc text-white pb-4">Through events and workshops, we promote mutual
                                understanding and global citizenship,
                                <br> offering insights into diverse traditions and values.
                            </p>
                        </div>
            ...
            <div class="hero-slider-item hero-bg-4">
                <div class="container">
                    <div class="hero-content text-center">
                        <div class="section-heading">
                            <h2 class="section__title text-white fs-65 lh-80 pb-3">Experienced <br> Instructors!</h2>
                            <p class="section__desc text-white pb-4">Our team of skilled instructors utilizes
                                cutting-edge methodologies
                                <br> to ensure effective language acquisition and meaningful cultural engagement.
                            </p>
                        </div><!-- end section-heading -->
                        {{-- <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1 justify-content-center">
                        <a href="admission.html" class="btn theme-btn mr-4 mb-4">Get Started <i class="la la-arrow-right icon ml-1"></i></a>
            ...
            <div class="hero-slider-item hero-bg-5">
                <div class="container">
                    <div class="hero-content text-right">
                        <div class="section-heading">
                            <h2 class="section__title text-white fs-65 lh-80 pb-3">Community <br> Engagement
                            </h2>
                            <p class="section__desc text-white pb-4">We actively collaborate with local communities and
                                international organizations
                                <br> to create enriching experiences that bridge cultural divides and promote
            ...
            <div class="row feature-content-wrap">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <p class="info__text">Get Certificates Achieve recognized credentials through our programs ...
                        </p>
                    </div><!-- end info-box -->
                </div><!-- end col-lg-3 -->
            </div><!-- end row -->
                ...
                <div class="col-lg-9">
                    <div class="category-content-wrap">
                        <div class="section-heading">
                            ...
                            <h2 class="section__title">Language Training </h2>
                ...
                <div class="row">
                    <div class="col-lg-4 responsive-column-half">
                        <div class="category-item">
                            <img class="cat__img lazy" src="images/img-loading.png"
                                data-src="{{ asset('assets/images/img1.jpg') }}" alt="Category image">
                            <div class="category-content">
                                <div class="category-inner">
                                    <h3 class="cat__title"><a href="#">English</a></h3>
                                    <p class="cat__meta">Open to English-speaking students and citizens and to
                                        foreigners in general</p>
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="category-item">
                            <img class="cat__img lazy" src="images/img-loading.png"
                                data-src="{{ asset('assets/images/img2.jpg') }}" alt="Category image">
                            <div class="category-content">
                                <div class="category-inner">
                                    <h3 class="cat__title"><a href="#">French</a></h3>
                                    <p class="cat__meta">Open to French speaking courses</p>
                                    {{-- <a href="#" class="btn theme-btn theme-btn-sm theme-btn-white">Explore<i
                                            class="la la-arrow-right icon ml-1"></i></a> --}}
                                </div>
                            </div><!-- end category-content -->
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="category-item">
                            <img class="cat__img lazy" src="images/img-loading.png"
                                data-src="{{ asset('assets/images/img3.jpg') }}" alt="Category image">
                            <div class="category-content">
                                <div class="category-inner">
                                    <h3 class="cat__title"><a href="#">German</a></h3>
                                    <p class="cat__meta">To take the Start Deutsch 1, Zertifikat A2, B1 and B2
                                        proficiency tests, the DAF test, etc.</p>
                                    {{-- <a href="#" class="btn theme-btn theme-btn-sm theme-btn-white">Explore<i
                                            class="la la-arrow-right icon ml-1"></i></a> --}}
                                </div>
                            </div><!-- end category-content -->
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="category-item">
                            <img class="cat__img lazy" src="images/img-loading.png"
                                data-src="{{ asset('assets/images/img4.jpg') }}" alt="Category image">
                            <div class="category-content">
                                <div class="category-inner">
                                    <h3 class="cat__title"><a href="#">Xwlagbe</a></h3>
                                    <p class="cat__meta">Open to speakers of Xwlagbe who want to read, write,
                                        understand and speak their mother tongue fluently, and to anyone else
                                        interested.</p>
                                    {{-- <a href="#" class="btn theme-btn theme-btn-sm theme-btn-white">Explore<i
                                            class="la la-arrow-right icon ml-1"></i></a> --}}
                                </div>
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="category-item">
                            <img class="cat__img lazy" src="images/img-loading.png"
                                data-src="{{ asset('assets/images/img5.jpg') }}" alt="Category image">
                            <div class="category-content">
                                <div class="category-inner">
                                    <h3 class="cat__title"><a href="#">Fongbe</a></h3>
                                    <p class="cat__meta">Open to speakers of Fongbe who want to read, write, understand
                                        and speak their mother tongue fluently, and to anyone else interested. </p>
                                    {{-- <a href="#" class="btn theme-btn theme-btn-sm theme-btn-white">Explore<i
                                            class="la la-arrow-right icon ml-1"></i></a> --}}
                                </div>
                            </div><!-- end category-content -->
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="category-item">
                            <img class="cat__img lazy" src="images/img-loading.png"
                                data-src="{{ asset('assets/images/img6.jpg') }}" alt="Category image">
                            <div class="category-content">
                                <div class="category-inner">
                                    <h3 class="cat__title"><a href="#">Gungbe and Yoruba</a></h3>
                                    <p class="cat__meta">Open to speakers of Gungbe and Yoruba who want to read, write,
                                        understand and speak their mother tongue fluently, and to anyone else
                                        interested. </p>
                                    {{-- <a href="#" class="btn theme-btn theme-btn-sm theme-btn-white">Explore<i
                                            class="la la-arrow-right icon ml-1"></i></a> --}}
            ...
            <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="french-tab" data-toggle="tab" href="#french" role="tab"
                        aria-controls="french" aria-selected="false">French</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="german-tab" data-toggle="tab" href="#german" role="tab"
                        aria-controls="german" aria-selected="false">German</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="xwlagbe-tab" data-toggle="tab" href="#xwlagbe" role="tab"
                        aria-controls="xwlagbe" aria-selected="false">Xwlagbe,Fongbe,Gungbe and Yoruba</a>
                </li>
                <li class="nav-item">
        ...
        <div class="card-content-wrapper bg-gray pt-50px pb-120px">
            <div class="container">
                <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row">
                                ...
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                    <div class="card-image">
                                        <a href="#" class="d-block">
                                            <img class="card-img-top lazy" src="{{ asset('assets/images/img8.jpg') }}"
                                                alt="Card image cap">
                                        </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title"><a href="#">English for Business
                                                Communication</a></h5>
                                        <p class="card-text"><a href="#">Bridge</a></p>
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                    <div class="card-image">
                                        <a href="#" class="d-block">
                                            <img class="card-img-top lazy" src="{{ asset('assets/images/img9.jpg') }}"
                                                alt="Card image cap">
                                        </a>
                                        <div class="course-badge-labels">
                                    ...
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                                        <h5 class="card-title"><a href="#">Academic Writing and
                                                Research Skills</a></h5>
                                        <p class="card-text"><a href="#">Bridge</a></p>
                                        <div class="rating-wrap d-flex align-items-center py-2">
                                            <div class="review-stars">
                                                <span class="rating-number">4.4</span>
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                    <div class="card-image">
                                        <a href="#" class="d-block">
                                            <img class="card-img-top lazy"
                                                src="{{ asset('assets/images/img10.jpg') }}" alt="Card image cap">
                                        </a>
                                        <div class="course-badge-labels">
                                    ...
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                                        <h5 class="card-title"><a href="#">Conversational English: Everyday
                                                Expressions</a></h5>
                                        <p class="card-text"><a href="#">Bridge</a></p>
                                        <div class="rating-wrap d-flex align-items-center py-2">
                                            <div class="review-stars">
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_2">
                                    <div class="card-image">
                                        <a href="#" class="d-block">
                                            <img class="card-img-top lazy"
                                                src="{{ asset('assets/images/img11.jpg') }}" alt="Card image cap">
                                        </a>
                                    </div><!-- end card-image -->
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">Beginner</h6>
                                        <h5 class="card-title"><a href="#">French for Beginners</a></h5>
                                        <p class="card-text"><a href="#">Bridge</a></p>
                                        <div class="rating-wrap d-flex align-items-center py-2">
                                            <div class="review-stars">
                                                <span class="rating-number">4.4</span>
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_2">
                                    <div class="card-image">
                                        <a href="#" class="d-block">
                                            <img class="card-img-top lazy"
                                                src="{{ asset('assets/images/img12.jpg') }}" alt="Card image cap">
                                        </a>
                                        <div class="course-badge-labels">
                                    ...
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">Beginner</h6>
                                        <h5 class="card-title"><a href="#">Business French</a></h5>
                                        <p class="card-text"><a href="#">Bridge</a></p>
                                        <div class="rating-wrap d-flex align-items-center py-2">
                                            <div class="review-stars">
                                                <span class="rating-number">4.4</span>
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_2">
                                    <div class="card-image">
                                        <a href="#" class="d-block">
                                            <img class="card-img-top lazy"
                                                src="{{ asset('assets/images/img13.jpg') }}" alt="Card image cap">
                                        </a>
                                        <div class="course-badge-labels">
                                            <div class="course-badge sky-blue">Highest rated</div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">Beginner</h6>
                                        <h5 class="card-title"><a href="#">Conversation in French: Daily
                                                Themes</a></h5>
                                        <p class="card-text"><a href="#">Bridge</a></p>
                                        <div class="rating-wrap d-flex align-items-center py-2">
                                            <div class="review-stars">
                    ...
                    <div class="tab-pane fade" id="xwlagbe" role="tabpanel" aria-labelledby="xwlagbe-tab">
                        <div class="row">
                            ...
                        </div><!-- end row -->
                    </div><!-- end tab-pane -->
            ...
            <div class="container">
                ...
                <div class="course-carousel owl-action-styled owl--action-styled mt-30px">
                    ...
                    <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                        <div class="card-image">
                            <a href="#" class="d-block">
                                <img class="card-img-top lazy" src="{{ asset('assets/images/img12.jpg') }}"
                                    alt="Card image cap">
                            </a>
                            <div class="course-badge-labels">
                                <div class="course-badge green">Free</div>
                    ...
                    <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                        <div class="card-image">
                            <a href="#" class="d-block">
                                <img class="card-img-top lazy" src="{{ asset('assets/images/img13.jpg') }}"
                                    alt="Card image cap">
                            </a>
                        </div><!-- end card-image -->
                        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-3 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <h4 class="counter__title counter text-color-2">10</h4>
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <h4 class="counter__title counter text-color-3">252</h4>
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <h4 class="counter__title counter text-color-5">5</h4>
            ...
            <div class="testimonial-carousel owl-action-styled">
                    ...
                    <div class="card-body">
                        <div class="media media-card align-items-center pb-3">
                            <div class="media-img avatar-md">
                                <img src="{{ asset('assets/images/small-avatar-1.jpg') }}" alt="Testimonial avatar"
                                    class="rounded-full">
                            </div>
                        ...
                        <p class="card-text">
                            My children and I LOVE Bridge! The courses are fantastic and the
                ...
                {{-- <div class="card card-item">
                    <div class="card-body">
                        <div class="media media-card align-items-center pb-3">
                            <div class="media-img avatar-md">
                                <img src="{{ asset('assets/images/small-avatar-2.jpg') }}" alt="Testimonial avatar" class="rounded-full">
                            </div>
                            <div class="media-body">
                ...
                <div class="card card-item">
                    <div class="card-body">
                        <div class="media media-card align-items-center pb-3">
                            <div class="media-img avatar-md">
                                <img src="{{ asset('assets/images/small-avatar-3.jpg') }}" alt="Testimonial avatar"
                                    class="rounded-full">
                            </div>
                            <div class="media-body">
                                <h5>Jackob Hallac</h5>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content pb-5">
                        <div class="section-heading">
                            ...
                            <h2 class="section__title">Benefits of Learning With Bridge</h2>
                            <span class="section-divider"></span>
                            <p class="section__desc">
                                The benefits of learning with Bridge include tailored curriculum, experienced
                                instructors, cultural immersion, flexible scheduling, globally recognized certification,
                                supportive community, cutting-edge resources, career advancement, confidence building,
                ...
                <div class="col-lg-5 ml-auto">
                    <div class="generic-img-box">
                        <img src="{{ asset('assets/images/img13.jpg') }}" alt="About image"
                            class="img__item img__item-1 lazy">
                        <img src="{{ asset('assets/images/img8.jpg') }}" alt="About image"
        ...
        <div class="container">
            <div class="section-heading">
                ...
                <h2 class="section__title">Top companies choose <a href="for-business.html"
                        class="text-color hover-underline">Bridge for Business</a> to build
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item hover-s text-center">
                        <div class="card-body">
                            <img src="{{ asset('assets/images/small-img-3.jpg') }}" alt="card image"
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item hover-s text-center">
                        <div class="card-body">
                            <img src="{{ asset('assets/images/small-img-4.jpg') }}" alt="card image"
                                class="img-fluid rounded-full lazy">
                            <h5 class="card-title pt-4 pb-2">Bridge for Business</h5>
                            <p class="card-text">Get unlimited access to 5,000+ of Bridge's top courses for your team
                            </p>
                            <div class="btn-box mt-20px">
                                <a href="for-business.html"
                                    class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i
                                        class="la la-briefcase mr-1"></i>Get bridge for business</a>
                            </div><!-- end btn-box -->
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                </div><!-- end col-lg-4 -->
    ...
    <section class="footer-area pt-100px">
            ...
            <div class="row">
                <div class="col-lg-3 responsive-column-half">
                    <div class="footer-item">
                        <a href="index.html">
                            <img src="{{ asset('assets/images/logo.png')}}" style="height: 100px;"  alt="footer logo" class="footer__logo">
                        </a>
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="footer-item">
                        <h3 class="fs-20 font-weight-semi-bold">Cotonou, 12th Arrondissement, Aïbatin, lot 1596 </h3>
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="footer-item">
                        <h3 class="fs-20 font-weight-semi-bold">Bank account no. 33046050007</h3>
        ...
        <div class="copyright-content py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <p class="copy-desc">&copy; 2024 Bridge. All Rights Reserved. by <a
