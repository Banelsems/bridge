        ...
        <div class="container">
            <div class="breadcrumb-content">
                <div class="section-heading') }}">
                    <h5 class="ribbon ribbon-lg ribbon-white mb-2">Welcome to BRIDGE LANGUAGE AND CULTURE INSTITUTE</h5>
                ...
                <div class="breadcrumb-btn-box pt-40px pl-3">
                    <a href="#" class="btn-text text-white video-play-btn d-inline-flex align-items-center"
                        data-fancybox data-src="{{ asset('assets/videos/videoabout.mp4') }}">
                        <span class="icon-element icon-element-md pulse-btn mr-3"><i class="la la-play"></i></span>
    ...
    <section class="get-started-area pt-30px pb-120px position-relative">
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="card card-item hover-s text-center">
                        <div class="card-body">
                            <img src="{{ asset('assets/images/img-loading.png') }}"
                                data-src="{{ asset('assets/images/small-img-2.jpg') }}" alt="card image"
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item hover-s text-center">
                        <div class="card-body">
                            <img src="{{ asset('assets/images/img-loading.png') }}"
                                data-src="{{ asset('assets/images/small-img-3.jpg') }}" alt="card image"
                                class="img-fluid lazy rounded-full">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item hover-s text-center">
                        <div class="card-body">
                            <img src="{{ asset('assets/images/img-loading.png') }}"
                                data-src="{{ asset('assets/images/small-img-4.jpg') }}" alt="card image"
                                class="img-fluid lazy rounded-full">
            ...
            <p class="text-center">Want to join with us? See our<a href="careers.html"
                    class="text-color hover-underline"> open positions</a></p>
        </div><!-- end container -->
                ...
                <div class="col-lg-6">
                    <div class="row pb-5">
                        ...
                        <div class="col-lg-6 responsive-column-half">
                            <div class="img-box">
                                <img src="{{ asset('assets/images/img-loading.png') }}"
                                    data-src="{{ asset('assets/images/Empowerteachers.jpg') }}"
                                    alt="our mission image" class="img-fluid lazy rounded-rounded">
                            </div>
                        </div><!-- end col-lg-6 -->
                        <div class="col-lg-6 responsive-column-half">
                            <div class="img-box my-3">
                                <img src="{{ asset('assets/images/img-loading.png') }}"
                                    data-src="{{ asset('assets/images/Trustedcontent.jpg') }}"
                                    alt="our mission image" class="img-fluid lazy rounded-rounded">
                            </div>
                        </div><!-- end col-lg-6 -->
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="about-content pl-4">
                        <div class="section-heading') }}">
                            ...
                            <p class="section__desc pb-3">Enhancing the socio-cultural and economic prominence of Benin
                                at the national, regional, and international levels by developing the linguistic and
                                communication skills of all stakeholders. </p>
                            <p class="section__desc text-black">This involves supporting public and private
                                institutions, as well as civil society, in their communication efforts and in
                                strengthening the capacities of their human resources through practical language
            ...
            <div class="row pt-60px">
                <div class="col-lg-4 responsive-column-half">
                    <div class="story-img-item">
                        <img class="lazy" src="{{ asset('assets/images/img-loading.png') }}"
                            data-src="{{ asset('assets/images/img3.jpg') }}" alt="Story image">
                    </div>
                </div><!-- end col-lg-4 -->
                <div class="col-lg-4 responsive-column-half">
                    <div class="story-img-item mt-90px">
                        <img class="lazy" src="{{ asset('assets/images/img-loading.png') }}"
                            data-src="{{ asset('assets/images/img9.jpg') }}" alt="Story image">
                        <a href="#" class="video-play-btn" data-fancybox=""
                            data-src="{{ asset('assets/videos/videoabout.mp4') }}">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="story-img-item">
                        <img class="lazy" src="{{ asset('assets/images/img-loading.png') }}"
                            data-src="{{ asset('assets/images/img4.jpg') }}" alt="Story image">
                    </div>
                </div><!-- end col-lg-4 -->
            </div><!-- end row -->
        </div><!-- end container -->
        ...
        <div class="container">
            ...
            <div class="row pt-60px">
                <div class="col-lg-3 responsive-column-half">
                    <div class="card card-item member-card text-center">
                        <div class="card-image">
                            <img class="card-img-top" src="{{ asset('assets/images/small-avatar-1.jpg') }}"
                                alt="team member">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="card card-item member-card text-center">
                        <div class="card-image">
                            <img class="card-img-top" src="{{ asset('assets/images/small-avatar-2.jpg') }}"
                                alt="team member">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="card card-item member-card text-center">
                        <div class="card-image">
                            <img class="card-img-top" src="{{ asset('assets/images/small-avatar-3.jpg') }}"
                                alt="team member">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="card card-item member-card text-center">
                        <div class="card-image">
                            <img class="card-img-top" src="{{ asset('assets/images/small-avatar-4.jpg') }}"
                                alt="team member">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="card card-item member-card text-center">
                        <div class="card-image">
                            <img class="card-img-top" src="{{ asset('assets/images/small-avatar-5.jpg') }}"
                                alt="team member">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="card card-item member-card text-center">
                        <div class="card-image">
                            <img class="card-img-top" src="{{ asset('assets/images/small-avatar-7.jpg') }}"
                                alt="team member">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="testimonial-carousel-2 owl-action-styled owl-action-styled-2">
                            ...
                            <div class="card-body">
                                ...
                                <div class="media media-card align-items-center pt-4">
                                    <div class="media-img avatar-md">
                                        <img src="{{ asset('assets/images/small-avatar-1.jpg') }}"
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                ...
                                <div class="media media-card align-items-center pt-4">
                                    <div class="media-img avatar-md">
                                        <img src="{{ asset('assets/images/small-avatar-2.jpg') }}"
                                            alt="Testimonial avatar" class="rounded-full">
                                    </div>
                                    <div class="media-body">
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                ...
                                <div class="media media-card align-items-center pt-4">
                                    <div class="media-img avatar-md">
                                        <img src="{{ asset('assets/images/small-avatar-3.jpg') }}"
                                            alt="Testimonial avatar" class="rounded-full">
                                    </div>
                                    <div class="media-body">
                                        <h5>Jackob Hallac</h5>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <div class="cta-btn-box text-right">
                    <a href="become-a-teacher.html" class="btn theme-btn">Tech on BRIDGE LANGUAGE AND CULTURE INSTITUTE <i class="la la-arrow-right icon ml-1"></i></a>
                </div>
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="generic-img-box generic-img-box-layout-3">
                    <img src="{{ asset('assets/images/img-loading.png') }}" data-src="{{ asset('assets/images/img13.jpg') }}" alt="About image" class="img__item lazy img__item-1">
                </div>
            </div><!-- end col-lg-6 -->
        </div><!-- end row -->
    </div><!-- end container -->
...
================================= -->
    ...
    <div class="container">
        ...
        <div class="client-logo-carousel pt-40px">
            <a href="#" class="client-logo-item"><img src="{{ asset('assets/images/sponsor-img.png') }}" alt="brand image"></a>
            <a href="#" class="client-logo-item"><img src="{{ asset('assets/images/sponsor-img2.png') }}" alt="brand image"></a>
            <a href="#" class="client-logo-item"><img src="{{ asset('assets/images/sponsor-img3.png') }}" alt="brand image"></a>
            <a href="#" class="client-logo-item"><img src="{{ asset('assets/images/sponsor-img4.png') }}" alt="brand image"></a>
            <a href="#" class="client-logo-item"><img src="{{ asset('assets/images/sponsor-img5.png') }}" alt="brand image"></a>
