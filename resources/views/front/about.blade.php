            ...
            <div class="breadcrumb-content">
                ...
                <div class="breadcrumb-btn-box pt-40px pl-3">
                    <a href="#" class="btn-text text-white video-play-btn d-inline-flex align-items-center"
                        ...
                        <span class="icon-element icon-element-md pulse-btn mr-3"><i class="la la-play"></i></span>Watch
                        the Video
                    </a>
                </div>
                    ...
                    <div class="about-content pb-5">
                        <div class="section-heading">
                            <h2 class="section__title pb-3 lh-50">The leading global marketplace for learning and
                                instruction</h2>
                            <p class="section__desc">Nemo enim ipsam,voluptatem quia voluptas sit aspernatur aut odit
                                aut fugit, sed quia,consequuntur magni dolores eos qui ratione voluptatem sequi
                                nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, adipisci
                        ...
                        <ul class="generic-list-item pt-3">
                            <li><i class="la la-check-circle mr-2 text-success"></i>Online Courses with full discount
                                systems.</li>
                            <li><i class="la la-check-circle mr-2 text-success"></i>Online Certificates which can be
                                used worldwide.</li>
                            <li><i class="la la-check-circle mr-2 text-success"></i>An online leadership development
                                program at BRIDGE LANGUAGE AND CULTURE INSTITUTE.</li>
                        </ul>
                ...
                <div class="col-lg-6">
                    <div class="generic-img-box generic-img-box-layout-2">
                        <div class="img__item img__item-1">
                            <img class="lazy" src="images/img-loading.png" data-src="images/img15.jpg"
                                alt="About image">
                        ...
                        <div class="img__item img__item-2">
                            <img class="lazy" src="images/img-loading.png" data-src="images/img16.jpg"
                                alt="About image">
                            <div class="generic-img-box-content">
                        ...
                        <div class="img__item img__item-3">
                            <img class="lazy" src="images/img-loading.png" data-src="images/img17.jpg"
                                alt="About image">
                            <div class="generic-img-box-content">
                ...
                <div class="col-lg-6">
                    <div class="row pb-5">
                        <div class="col-lg-6 responsive-column-half">
                            <div class="img-box">
                                <img src="images/img-loading.png" data-src="images/img8.jpg" alt="our mission image"
                                    class="img-fluid lazy rounded-rounded">
                            </div>
                        </div><!-- end col-lg-6 -->
                        <div class="col-lg-6 responsive-column-half">
                            <div class="img-box my-3">
                                <img src="images/img-loading.png" data-src="images/img10.jpg" alt="our mission image"
                                    class="img-fluid lazy rounded-rounded">
                            </div>
                        </div><!-- end col-lg-6 -->
                        <div class="col-lg-6 responsive-column-half">
                            <div class="img-box">
                                <img src="images/img-loading.png" data-src="images/img11.jpg" alt="our mission image"
                                    class="img-fluid lazy rounded-rounded">
                            </div>
                        </div><!-- end col-lg-6 -->
                        <div class="col-lg-6 responsive-column-half">
                            <div class="img-box my-3">
                                <img src="images/img-loading.png" data-src="images/img12.jpg" alt="our mission image"
                                    class="img-fluid lazy rounded-rounded">
                            </div>
                        </div><!-- end col-lg-6 -->
                    </div>
                    ...
                    <div class="about-content pl-4">
                        <div class="section-heading">
                            ...
                            <p class="section__desc pb-3">We’re not one of those companies. We are rethinking education
                                ...
                                networking, healthcare, and more. We are building the education the world needs - the
                                first truly net native education. We take more cues from modern tech innovators in
                                creating an engaging educational experience than we do from the classroom.</p>
                            <p class="section__desc text-black">Education is broken. Come help us build the education
                                the world deserves.</p>
                        </div><!-- end section-heading -->
                    </div><!-- end about-content -->
                </div><!-- end col-lg-6 -->
            </div><!-- end row -->
            ...
            <div class="row pt-60px">
                <div class="col-lg-4 responsive-column-half">
                    <div class="story-img-item">
                        <img class="lazy" src="images/img-loading.png" data-src="images/img37.jpg"
                            alt="Story image">
                    </div>
                </div><!-- end col-lg-4 -->
                <div class="col-lg-4 responsive-column-half">
                    <div class="story-img-item mt-90px">
                        <img class="lazy" src="images/img-loading.png" data-src="images/img38.jpg"
                            alt="Story image">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="story-img-item">
                        <img class="lazy" src="images/img-loading.png" data-src="images/img39.jpg"
                            alt="Story image">
                    </div>
                </div><!-- end col-lg-4 -->
            </div><!-- end row -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <div class="cta-content-wrap media py-4 align-items-center">
                        ...
                        <div class="media-body">
                            ...
                            <p class="fs-17">Create an online video course, reach students across the globe, and earn
                                money</p>
                        </div>
                    </div><!-- end media -->
                </div><!-- end col-lg-9 -->
                <div class="col-lg-3">
                    <div class="cta-btn-box text-right">
                        <a href="become-a-teacher.html" class="btn theme-btn">Tech on BRIDGE LANGUAGE AND CULTURE
                            INSTITUTE <i class="la la-arrow-right icon ml-1"></i></a>
                    </div>
                </div><!-- end col-lg-3 -->
            </div><!-- end row -->
        </div><!-- end container -->
                ...
                <div class="col-lg-6">
                    <div class="about-content pb-5">
                        <div class="section-heading">
                            ...
                            <p class="section__desc pb-3">Nemo enim ipsam,voluptatem quia voluptas sit aspernatur aut
                                odit aut fugit, sed quia,consequuntur magni dolores eos qui ratione voluptatem sequi
                                nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, adipisci
                                velit, sed quia non numquam eius modi tempora</p>
                            <p class="section__desc">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet,
    ...
    <section class="client-logo-area section--padding position-relative overflow-hidden text-center">
        ...
        <div class="container">
            <div class="section-heading">
                ...
                <p class="section__desc">Get access to high quality learning wherever you are, with online courses,
                    programs
                    <br>and degrees created by leading universities, business schools
                </p>
            </div><!-- end section-heading -->
