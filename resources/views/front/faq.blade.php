            ...
            <div class="row">
                <div class="col-lg-7">
                    <div id="accordion" class="generic-accordion generic-accordion-layout-2">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="card-body">
                                    <p class="card-text">Investiga tiones demonstr averun lectores legere melius quod
                                        kequa legunt saepius. Claritas est etiam pro cessus dynamicus qui sequitur
                                        mutatin onem consuetudium. Investiga tiones demonstr averunt lectores legere me
                                        liusked quod kequa legunt saepius. Claritas est etiam pro cessus. Sequitur
                                        mutatin onem consuetudium.</p>
                                </div><!-- end card-body -->
                            </div><!-- end collapse -->
                        </div><!-- end card -->
                        <div class="card">
                    ...
                    <div class="load-more-btn-box pt-5 text-center">
                        <button type="button" class="btn theme-btn"><i class="la la-refresh mr-1"></i> load
                            more</button>
                    </div>
                </div><!-- end col-lg-7-->
                <div class="col-lg-5">
