...
<head>
    ...
    <title>BRIDGE LANGUAGE AND CULTURE INSTITUTE - Education HTML Template</title>
    ...
    <header class="header-menu-area bg-white">
                ...
                <div class="row align-items-center">
                        ...
                        <div class="header-widget">
                            <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                                ...
                                <li class="d-flex align-items-center"><i class="la la-envelope-o mr-1"></i><a
                                        href="mailto:contact@BRIDGE LANGUAGE AND CULTURE INSTITUTE.com"> contact@BRIDGE
                                        LANGUAGE AND CULTURE INSTITUTE.com</a></li>
                            </ul>
                    ...
                    <div class="col-lg-6">
                        <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                            <div
                                class="theme-picker d-flex align-items-center border-right border-right-gray mr-3 pr-3">
                        ...
                        <div class="col-lg-9">
                            <div class="menu-wrapper">
                                                    ...
                                                    <li class="col-lg-3">
                                                        <div class="menu-banner position-relative h-100">
                                                            ...
                                                            <div
                                                                ...
                                                                <h4
                                                                    class="fs-20 font-weight-bold pb-3 text-white lh-26">
                                                                    Try BRIDGE LANGUAGE AND CULTURE INSTITUTE free for
                                                                    one month</h4>
                                                                <a href="sign-up.html"
                                ...
                                <div class="nav-right-button">
                                    <a href="login.html"
                                        class="btn theme-btn theme-btn-sm lh-26 theme-btn-transparent mr-2"><i
                                            class="la la-sign-in mr-1"></i> Login</a>
                                    <a href="sign-up.html" class="btn theme-btn theme-btn-sm lh-26 shadow-none"><i
        ...
        <div class="off-canvas-menu custom-scrollbar-styled main-off-canvas-menu">
            ...
            <div class="btn-box px-4 pt-5 text-center">
                ...
                <a href="sign-up.html" class="btn theme-btn theme-btn-sm shadow-none"><i class="la la-plus mr-1"></i>
                    Sign up</a>
            </div>
            ...
            <div class="container">
                <div class="hero-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title fs-60 lh-80 pb-3 theme-font-2">The latest digital skills, <br> within
                            reach.</h2>
                        <p class="section__desc pb-5">Discover the fastest, most effective way to gain job-ready <br>
                            expertise for the careers of the future.</p>
                    </div><!-- end section-heading -->
                    <form method="post" class="w-50 mx-auto">
                        <div class="form-group mb-0">
                            <input class="form-control form--control pl-3 shadow-sm border-0" type="text"
                                name="search" placeholder="What do you wnat to learn?">
            ...
            <div class="row">
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box info--box hover-y">
                        ...
                        <p class="info__text">Choose what you’d like to learn from our extensive subscription library
                        </p>
                    </div><!-- end info-box -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-4 responsive-column-half">
                ...
                <div class="featured-course-carousel owl-action-styled owl--action-styled">
                    <div class="card card-item card-item-list-layout border border-gray shadow-none">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title pb-1"><a href="course-details.html">Django with React | An Ecommerce
                                    Website</a></h5>
                            <p class="card-text lh-24 pb-1">Build an eCommerce platform from the ground up with React,
                            ...
                            <div class="d-flex flex-wrap align-items-center fs-14">
                                <p class="text-success font-weight-medium pb-2 mr-2">Updated<span
                    ...
                    <div class="card card-item card-item-list-layout border border-gray shadow-none">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title pb-1"><a href="course-details.html">Python for Data Science and
                                    Machine Learning Bootcamp</a></h5>
                            <p class="card-text lh-24 pb-1">Learn how to use NumPy, Pandas, Seaborn , Matplotlib ,
                    ...
                    <div class="card card-item card-item-list-layout border border-gray shadow-none">
                        ...
                        <div class="card-body">
                            <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                            <h5 class="card-title pb-1"><a href="course-details.html">Java Programming Masterclass for
                                    Software Developers</a></h5>
                            <p class="card-text lh-24 pb-1">Learn Java In This Course And Become a Computer Programmer.
        ...
        <div class="course-wrapper">
            <div class="container">
                <div class="section-heading text-center">
                    ...
                    <p class="section__desc">Only BRIDGE LANGUAGE AND CULTURE INSTITUTE has all the critical factors
                        to deliver real results</p>
                </div><!-- end section-heading -->
            ...
            <div class="row pt-50px">
                <div class="col-lg-4 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <p class="counter__meta">BRIDGE LANGUAGE AND CULTURE INSTITUTE graduations and <br> counting
                        </p>
    ...
    <section class="cat-area pt-80px pb-80px bg-radial-gradient-gray">
        <div class="container">
            <div class="cta-content-wrap text-center">
                <div class="section-heading">
                    <h2 class="section__title fs-45 lh-55 theme-font-2 pb-4">Make the most of your online <br>
                ...
                <div class="card card-item border border-gray shadow-none">
                    <div class="card-body">
                        ...
                        <p class="card-text pb-4">
                            My children and I LOVE BRIDGE LANGUAGE AND CULTURE INSTITUTE! The courses are fantastic and
                            the
...
======================================-->
    <section class="cat-area pt-80px pb-80px bg-radial-gradient-gray">
        <div class="container">
            <div class="cta-content-wrap text-center">
                <div class="section-heading">
                    <h2 class="section__title lh-50 theme-font-2 pb-4">Give your team a faster way <br> to learn and
                        apply new skills.</h2>
                    <p class="section__desc">Get unlimited access to 5,000+ of BRIDGE LANGUAGE AND CULTURE INSTITUTE’s
                        top courses for your team.</p>
                </div><!-- end section-heading -->
                <div class="cat-btn-box mt-28px">
    ...
    <section class="footer-area pt-100px">
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="footer-item">
                        ...
                        <ul class="generic-list-item pt-4">
                            ...
                            <li><a href="for-business.html">BRIDGE LANGUAGE AND CULTURE INSTITUTE for Business</a>
                            </li>
        ...
        <div class="copyright-content py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <p class="copy-desc">&copy; 2021 BRIDGE LANGUAGE AND CULTURE INSTITUTE. All Rights Reserved.
                            by <a href="https://techydevs.com/">TechyDevs</a></p>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
