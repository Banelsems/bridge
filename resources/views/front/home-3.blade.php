                            ...
                            <div class="menu-wrapper">
                                ...
                                <div class="nav-right-button border-left border-left-gray pl-4 mr-3">
                                    <ul class="generic-list-item">
                                        ...
                                        <li>Or</li>
                                        <li><a href="sign-up.html" class="btn theme-btn theme-btn-sm text-white"><i
                                                    class="la la-user-plus mr-1"></i> Register</a></li>
                                    </ul>
                    ...
                    <div class="col-lg-7">
                        <div class="hero-content">
                            <div class="section-heading">
                                ...
                                <p class="section__desc text-white pb-4">Who tells you can’t do it? Build the
                                    confidence, skills, and qualifications to take control of your future. Start one of
                                    our 1000 high quality courses from the world’s leading experts today!</p>
                            </div><!-- end section-heading -->
                            <form method="post" class="w-75 pt-2">
                                <label
                                    class="label-text bg-white rounded py-1 px-2 fs-14 font-weight-medium lh-20">What
...
======================================-->
    <section class="get-started-area section--padding position-relative">
        <div class="container">
            <div class="section-heading text-center">
                <h2 class="section__title">Why Study with BRIDGE LANGUAGE AND CULTURE INSTITUTE</h2>
            </div><!-- end section-heading -->
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item text-center shadow-none rounded-0 bg-transparent">
                        <div class="card-body p-0">
                            ...
                            <p class="card-text">Phasellus enim magna, varius et commodo ut, ultricies vitae velit. Ut
                                nulla tellus</p>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                </div><!-- end col-lg-4 -->
        ...
        <div class="container">
            ...
            <div class="row pt-50px">
                <div class="col-lg-4 responsive-column-half">
                    <div class="flip-box">
                        <div class="flip-box-front">
                            <img src="images/img-loading.png" data-src="images/img1.jpg" alt=""
                                class="flip-img lazy">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="flip-box">
                        <div class="flip-box-front">
                            <img src="images/img-loading.png" data-src="images/img2.jpg" alt=""
                                class="flip-img lazy">
                            <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                                <div>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="flip-box">
                        <div class="flip-box-front">
                            <img src="images/img-loading.png" data-src="images/img3.jpg" alt=""
                                class="flip-img lazy">
                            <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                                <div>
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="flip-box">
                        <div class="flip-box-front">
                            <img src="images/img-loading.png" data-src="images/img4.jpg" alt=""
                                class="flip-img lazy">
                            <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                                <div>
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="flip-box">
                        <div class="flip-box-front">
                            <img src="images/img-loading.png" data-src="images/img5.jpg" alt=""
                                class="flip-img lazy">
                            <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                                <div>
                        ...
                        <div class="flip-box-back">
                            ...
                            <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                                <div>
                                    <div class="icon-element icon-element-md mx-auto mb-3">
                                        <svg class="svg-icon-color-5" width="35" version="1.1"
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="flip-box">
                        <div class="flip-box-front">
                            <img src="images/img-loading.png" data-src="images/img6.jpg" alt=""
                                class="flip-img lazy">
                            <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                                <div>
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="flip-box">
                        <div class="flip-box-front">
                            <img src="images/img-loading.png" data-src="images/img8.jpg" alt=""
                                class="flip-img lazy">
                            <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                                <div>
            ...
            <div class="view-more-box pt-4 text-center">
                <a href="categories.html" class="btn theme-btn">View all Category <i
    ...
    <section class="cat-area section-padding img-bg">
        ...
        <div class="container">
            <div class="cta-content-wrap text-center position-relative">
                <div class="section-heading">
                    <h2 class="section__title fs-40 lh-60 text-white">Why so late? Start one of our 2000 high quality
                        courses
                        from the world's leading experts today!</h2>
                </div><!-- end section-heading -->
                <div class="cat-btn-box mt-35px">
                    <a href="sign-up.html" class="btn theme-btn theme-btn-white">Get Started <i
                            class="la la-arrow-right icon ml-1"></i></a>
                </div><!-- end cat-btn-box -->
                    ...
                    <div class="card card-item hover-y">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="pl-4">
                                ...
                                <p class="card-text">Students practice at their own pace, first filling in gaps in
                                    their understanding and then accelerating</p>
                                <div class="btn-box mt-20px">
                                    <a href="become-a-teacher.html" class="btn theme-btn theme-btn-sm lh-30"><i
                                            class="la la-user mr-1"></i>Start Teaching</a>
                                </div><!-- end btn-box -->
                            </div>
                        </div><!-- end card-body -->
                        ...
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="pl-4">
                                ...
                                <p class="card-text">Created by experts, Coursector library of trusted practice and
                                    lessons covers math, science, and more.</p>
                                <div class="btn-box mt-20px">
                                    <a href="for-business.html" class="btn theme-btn theme-btn-sm lh-30"><i
                                            class="la la-briefcase mr-1"></i>Get BRIDGE LANGUAGE AND CULTURE INSTITUTE
                                        for Business</a>
                                </div><!-- end btn-box -->
                            </div>
                        </div><!-- end card-body -->
                        ...
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="pl-4">
                                ...
                                <p class="card-text">Created by experts, Coursector library of trusted practice and
                                    lessons covers math, science, and more.</p>
                                <div class="btn-box mt-20px">
                                    <a href="admission.html" class="btn theme-btn theme-btn-sm lh-30"><i
                                            class="la la-file-text-o mr-1"></i>Start Learning</a>
                                </div><!-- end btn-box -->
                            </div>
                        </div><!-- end card-body -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <p class="copy-desc">Copyright &copy; 2021 <a
