        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card card-item">
                        <div class="card-body">
                            <h2 class="card-title fs-18 pb-2">1. Welcome to BRIDGE LANGUAGE AND CULTURE INSTITUTE -
                                Education HTML Template</h2>
                            <div class="divider"><span></span></div>
                            <p class="pb-3 text-black">These terms and conditions outline the rules and regulations for
                                the use of BRIDGE LANGUAGE AND CULTURE INSTITUTE - Education HTML Template</p>
                            <p>
                                ...
                                was inventore veritatis keret quasi aperiam architecto beatae vitae dicta sunt
                                explicabo.
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <p class="pb-3">
                                ...
                                culpa dolore earum, eos, labore minima molestias natus nisi numquam provident quasi quis
                                quisquam reprehenderit velit voluptates! Nostrum, tenetur?
                            </p>
                            <p class="pb-1 text-black">You must not:</p>
                            <ul class="text-black">
                                <li>Republish material from https://BRIDGE LANGUAGE AND CULTURE INSTITUTE.com</li>
                                <li>Sell, rent or sub-license material from https://BRIDGE LANGUAGE AND CULTURE
                                    INSTITUTE.com</li>
                                <li>Reproduce, duplicate or copy material from https://BRIDGE LANGUAGE AND CULTURE
                                    INSTITUTE.com</li>
                            </ul>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <div class="divider"><span></span></div>
                            <p class="pb-3">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci consequuntur dolore
                                error fugit sequi ullam! A assumenda autem consequuntur doloribus esse illo, in
                                inventore ipsa itaque, maiores molestiae quos reiciendis saepe soluta sunt voluptas
                                voluptates. Aliquid assumenda hic laudantium ullam?
                            </p>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad, inventore suscipit.
                                Aliquid amet asperiores eveniet hic iusto libero magnam nemo reprehenderit unde. Animi
                                aspernatur culpa, ea eaque earum fugit labore.
                            </p>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                    <div class="card card-item">
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <div class="divider"><span></span></div>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto error illo nam quas
                                quo. Architecto dolores illum, mollitia possimus repellendus rerum. Corporis fugiat
                                minus nemo officia omnis saepe sed ut velit veritatis. Doloremque eveniet explicabo
                                optio placeat quod temporibus voluptate?
                            </p>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                    <div class="card card-item">
    ...
    <section class="footer-area pt-100px bg-gray">
        ...
        <div class="copyright-content py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <p class="copy-desc">&copy; 2021 BRIDGE LANGUAGE AND CULTURE INSTITUTE. All Rights Reserved. by
                            <a href="https://techydevs.com/">TechyDevs</a></p>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
